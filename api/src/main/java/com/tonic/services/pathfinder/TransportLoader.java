...
//        catch (IOException e)
//        {
//            Logger.error("Failed to load transports");
//        }
//
//        Logger.info("Loaded " + ALL_STATIC_TRANSPORTS.size() + " transports");
//    }
//
...
//
//                // Gnome Battlefield
//                if (VarAPI.getVarp(QuestVarPlayer.QUEST_TREE_GNOME_VILLAGE.getId()) >= 5)
//                {
